...
export const ArticleCard = ({ title, body, tagList, author, createdAt, favoritesCount, slug }) => {
  ...
  const tagArray = (tagList) => {
    const newArray = tagList.slice(0, 5);
    return newArray;
  };

  const shortTagList = tagArray(tagList);
      ...
      <div className={classes.left}>
        <div className={classes.twoValue}>
          ...
          <div className={classes.countLikes}>
            ...
            <div className={classes.favoriteCount}>{favoritesCount}</div>
          </div>
        </div>
        ...
        <div className={classes.article}>{truncate(200, body)}</div>
      </div>
      <div className={classes.right}>
        <div className={classes.info}>
          <div className={classes.user}>{author.username}</div>
